...
import featuredImage from "../../../assets/images/financial/mortgage.jpg";
  ...
  if (seo) {
    return (
      <>
        ...
        detailing the amount paid for interest and principal each …
      </>
    );
  }
  if (excerpt) {
    let excerpt = (
      <p>
        The mortgager calculator takes three items as input; (1) the principal
        amount of the mortgage, (2) the annual interest rate, and (3) the term
        of the loan in years. The program outputs the monthly payments,
        detailing the amount paid for interest and principal each …
      </p>
