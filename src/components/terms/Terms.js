    ...
    return (
      <div className="app container-fluid" style={{ margin: 0, padding: 0 }}>
        ...
        <div className="app content container-fluid terms-main">
          ...
          >
            <h1>
              Terms&nbsp;<i className="fa-solid fa-lock"></i>
            </h1>
            ...
            <ol id="terms-list">
              <li>
                ...
                <p>
                  ...
                  developers of this website (MD Web Technologies, jointly with
                  its proprietor Martin Dwyer), and you. It is made effective as
                  of the date of your use of this website at www.mdbytes.com
                  (&quot;Site&quot;) or the date of electronic acceptance. This
                  Agreement sets forth the general terms and conditions of your
                  use of the Site and the products and services
                </p>
                <p>
                  The terms “We”, “Us” or “Our” shall refer to the designers and
                  developers of this site; MD Web Technologies jointly with
                  proprietor Martin Dwyer. The terms “You”, “Your”, “User” or
                  “Customer” shall refer to any individual or entity who uses
                  this Site or has accepted the terms of this Agreement
                  electronically.
                </p>
                <p>
              ...
              <li>
                ...
                <p>
                  ...
                  <NavLink to="/calculator/privacy">Privacy Policy</NavLink>{" "}
                  found on this site{" "}
                  <NavLink to="/calculator/privacy">here</NavLink>, which
              ...
              <li>
                ...
                <p>
                  ...
                  <NavLink to="/calculator/contact">Contact Page</NavLink>.
                </p>
                <p>
              ...
              <li>
                ...
                <p>
                  ...
                  please contact Us by Our{" "}
                  <NavLink to="/calculator/contact">Contact Page</NavLink>. We
                  will clarify the services requested and, once clarified, You
                  will receive an electronic invoice for the services. Once the
                  initial payment is received, you will be contacted for an
              ...
              <li>
                ...
                <p>
                  ...
                  <NavLink to="/calculator/contact">Contact Page</NavLink>. We
                  will clarify the services requested and, once clarified, you
                  will receive an electronic invoice for the services. Once
                  payment is received, We will contact You to schedule Services.
                </p>
                <p>
              ...
              <li>
                ...
                <p>
                  ...
                  transmission links, hostile network attacks, network
              ...
              <li>
                ...
                <p>
                  ...
                  by Us. We assume no responsibility for the content, terms and
