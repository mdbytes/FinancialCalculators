...
import PastPresentFuture from "../components/PastPresentFuture";
import AnnuityValuation from "../components/AnnuityValuation";
...
export const allPosts = [
  {
    ...
    seo: ReactDOMServer.renderToStaticMarkup(<MortgageAmortization seo={true} />),
    author: 1,
    categories: [7],
  },
  {
