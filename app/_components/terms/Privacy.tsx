            ...
            <ol type="a">
              ...
              <li>
                ...
                <p>
                  ...
                  retained by Us to verify compliance with Our Universal Terms
                  of Service Agreement , to keep track of the domains from which
                  people visit us, to create a User profile, or to contact You
                  either electronically or otherwise.
                </p>
                <p>
                  If You choose to opt out of ongoing email communication,
                  please let us know through the{' '}
                  <Link href="/contact">Contact Page</Link> and we will not use
              ...
              <li>
                ...
                <p>
                  ...
                  <Link href="/contact">Contact Page</Link>. If You contact us
                  to correct Your User Information, we will attempt to correct
                  such inaccuracies in a timely manner.
                </p>
                <p>
              ...
              <li>
                ...
                <p>
                  ...
                  contact Us via our <Link href="/contact">Contact Page</Link> .
                </p>
              </li>
            </ol>
          </div>
